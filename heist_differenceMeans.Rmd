...
Copied from Andrew Heist's github repository for local testing
...
theme_fancy <- function() {
  theme_minimal(base_family = "Arial") + # Changed for now
...
download.file('https://raw.githubusercontent.com/andrewheiss/diff-means-half-dozen-ways/master/imdb_best.stan','imdb_best.stan')
stan_best <- 
